<div>
    ...
    <form class="text-sm mb-4 space-y-1" wire:submit="update">
        <input type="submit" class="bg-zinc-400 block p-2 mb-5 rounded-xl text-white cursor-pointer" value="Update Ticket">
        <p class="flex gap-4">
            <span class="basis-16 ">Status:</span> 
            <select class="uppercase font-bold" wire:model="ticketStatus" name="ticketStatus">
        ...
        <p class="flex gap-4">
            ...
            <select class="uppercase font-bold" wire:model="ticketPriority" name="ticketPriority">
